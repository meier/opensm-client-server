...
public class DumpNodes implements CommonLogger
{
  ...
  private static final String HEADER =
                          "DumpNodes - An OpenSM Service Client." + NEW_LINE + "A diagnostic for printing nodes.";
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    if (ParentSession != null)
    {
      ...
      /* use the api's to get the node information */
      OSM_Nodes AllNodes = clientInterface.getOsmNodes();
      if (AllNodes != null)
      {
        java.util.ArrayList<OSM_Node> nodes = OSM_Nodes.createOSM_Nodes(AllNodes, false);
        for (OSM_Node n : nodes)
          System.out.println(n);

        System.out.println("# Subnet nodes:  " + AllNodes.getSubnNodes().length);
        System.out.println("# PerfMgr nodes: " + AllNodes.getPerfMgrNodes().length);
        System.out.println("# Nodes:         " + nodes.size());
      }
      else
        logger.severe("getOsmNodes() returned null");
