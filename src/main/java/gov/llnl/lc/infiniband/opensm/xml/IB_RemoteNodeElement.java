 ...
 *
 *        file: IB_RemoteNodeElement.java
 *
...
/**********************************************************************
 * Describe purpose and responsibility of IB_RemoteNodeElement
 * <p>
 * @see  related classes and interfaces
 *
 * @author meier3
 * 
 * @version Nov 17, 2014 10:41:12 AM
 **********************************************************************/
public class IB_RemoteNodeElement implements Serializable
{
  /**  describe serialVersionUID here **/
  private static final long serialVersionUID = 332647677197577740L;

  private Node Root;
  
  private HashMap<String, String> AttributeMap = new HashMap<String, String>();
  
  public IB_RemoteNodeElement(Node root)
  {
    super();
  ...
  {
    return "IB_RemoteNodeElement [getElementName()=" + getElementName() + ", getName()=" + getName()
